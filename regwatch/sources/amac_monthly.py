...
def default_download_dir(config: Optional[Config] = None) -> Path:
            ...
            try:
                ...
                if attempt < MAX_RETRIES - 1:
                    ...
                    logger.warning(
                        ...
                        type(exc).__name__, wait, attempt + 1, MAX_RETRIES, url,
                    )
...
async def download_range(
    ...
    async with AsyncAMACCrawler() as crawler:
        for key, info in CATEGORIES.items():
            ...
            success, fail = await crawl_category(
                crawler, category_info, start_date, end_date, target_dir,
            )
    ...
    logger.info(
        ...
        summary["success"], summary["failed"], elapsed,
    )
    return summary
